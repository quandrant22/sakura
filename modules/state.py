...
# ── Подтверждение/отмена опасных системных команд ─────────────────────
# Общая логика для ws_handlers.py и main.py — проверяет вхождение слов
# по границам слов, с приоритетом отрицания.
