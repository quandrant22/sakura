...
def needs_search(text: str) -> bool:
    ...
    Правила:
      ...
      * Прямая просьба: глагол поиска в начале фразы («найди Х», «поищи Х»,
        «загугли Х», «погугли Х») + любое продолжение — ДА;
    ...
    if _word_in(tl, SEARCH_STOP):
        return False
    # Прямая просьба: глагол поиска в начале фразы + любое продолжение
